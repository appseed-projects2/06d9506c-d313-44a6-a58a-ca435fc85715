...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-27 20:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/06d9506c-d313-44a6-a58a-ca435fc85715.git
$ cd 06d9506c-d313-44a6-a58a-ca435fc85715
```
